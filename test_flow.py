...
# Create Birds
b1 = req('/api/birds', 'POST', {'identifier': 'B1', 'speciesId': None, 'breedId': null, 'isMale': True, 'status': 0}, token)
b2 = req('/api/birds', 'POST', {'identifier': 'B2', 'speciesId': None, 'breedId': null, 'isMale': False, 'status': 0}, token)
