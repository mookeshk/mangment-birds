                        ...
                        <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
                            {requests.length === 0 ? (
                                ...
                                <tr key={req.id} className="hover:bg-gray-50/50 dark:hover:bg-[#0f172a]/50 transition-colors">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <a href={`http://localhost:5089${req.receiptUrl}`} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 text-sm font-bold text-emerald-600 hover:text-emerald-700 dark:text-emerald-400 dark:hover:text-emerald-300 hover:underline">
